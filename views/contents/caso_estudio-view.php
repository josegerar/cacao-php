...
<nav>
    <div class="nav nav-tabs justify-content-center" id="registrar-caso-estudio-tab" role="tablist">
        <a class="nav-item nav-link active disabled" id="nav-home-tab" data-toggle="tab" href="#nav-caso-estudio" role="tab" aria-controls="nav-caso-estudio" aria-selected="true">Caso de estudio</a>
        <a class="nav-item nav-link disabled" id="nav-profile-tab" data-toggle="tab" href="#nav-localidad" role="tab" aria-controls="nav-localidad" aria-selected="false">Localidades</a>
        <a class="nav-item nav-link disabled" id="nav-contact-tab" data-toggle="tab" href="#nav-muestras" role="tab" aria-controls="nav-muestras" aria-selected="false">Muestras</a>
    </div>
</nav>
